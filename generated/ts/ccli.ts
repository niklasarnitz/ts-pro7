...
export function cCLIDocument_DisplayTypeFromJSON(object: any): CCLIDocument_DisplayType {
  switch (object) {
    case 0:
...
export function cCLIDocument_DisplayTypeToJSON(object: CCLIDocument_DisplayType): string {
  switch (object) {
...
function createBaseCCLIDocument(): CCLIDocument {
  return { applicationInfo: undefined, enableCcliDisplay: false, ccliLicense: "", displayType: 0, template: undefined };
}

export const CCLIDocument = {
  encode(message: CCLIDocument, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.template !== undefined) {
      Template_Slide.encode(message.template, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): CCLIDocument {
    return {
      ...
      enableCcliDisplay: isSet(object.enableCcliDisplay) ? Boolean(object.enableCcliDisplay) : false,
      ccliLicense: isSet(object.ccliLicense) ? String(object.ccliLicense) : "",
      displayType: isSet(object.displayType) ? cCLIDocument_DisplayTypeFromJSON(object.displayType) : 0,
      template: isSet(object.template) ? Template_Slide.fromJSON(object.template) : undefined,
    };
  },
  ...
  toJSON(message: CCLIDocument): unknown {
    ...
    message.enableCcliDisplay !== undefined && (obj.enableCcliDisplay = message.enableCcliDisplay);
    message.ccliLicense !== undefined && (obj.ccliLicense = message.ccliLicense);
    message.displayType !== undefined && (obj.displayType = cCLIDocument_DisplayTypeToJSON(message.displayType));
    message.template !== undefined &&
      (obj.template = message.template ? Template_Slide.toJSON(message.template) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<CCLIDocument>, I>>(object: I): CCLIDocument {
    const message = createBaseCCLIDocument();
