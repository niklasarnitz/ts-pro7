...
export const LiveVideoPlaylist = {
  encode(message: LiveVideoPlaylist, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromPartial<I extends Exact<DeepPartial<LiveVideoPlaylist>, I>>(object: I): LiveVideoPlaylist {
    const message = createBaseLiveVideoPlaylist();
