...
export function videoInput_AudioDeviceTypeFromJSON(object: any): VideoInput_AudioDeviceType {
  switch (object) {
    case 0:
...
export function videoInput_AudioDeviceTypeToJSON(object: VideoInput_AudioDeviceType): string {
  switch (object) {
...
export const VideoInput = {
  encode(message: VideoInput, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.videoInputDevice !== undefined) {
      Media_VideoDevice.encode(message.videoInputDevice, writer.uint32(26).fork()).ldelim();
    }
    ...
    if (message.audioDevice !== undefined) {
      DigitalAudio_Device.encode(message.audioDevice, writer.uint32(50).fork()).ldelim();
    }
    if (message.videoDevice !== undefined) {
      Media_VideoDevice.encode(message.videoDevice, writer.uint32(58).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.videoInputDevice = Media_VideoDevice.decode(reader, reader.uint32());
          break;
        case 4:
        ...
        case 8:
          ...
          break;
        case 6:
          message.audioDevice = DigitalAudio_Device.decode(reader, reader.uint32());
          break;
        case 7:
  ...
  fromJSON(object: any): VideoInput {
    return {
      ...
      userDescription: isSet(object.userDescription) ? String(object.userDescription) : "",
      videoInputDevice: isSet(object.videoInputDevice)
        ? Media_VideoDevice.fromJSON(object.videoInputDevice)
        : undefined,
      displayColor: isSet(object.displayColor) ? Color.fromJSON(object.displayColor) : undefined,
      thumbnailPath: isSet(object.thumbnailPath) ? URL.fromJSON(object.thumbnailPath) : undefined,
      audioType: isSet(object.audioType) ? videoInput_AudioDeviceTypeFromJSON(object.audioType) : 0,
      audioDevice: isSet(object.audioDevice) ? DigitalAudio_Device.fromJSON(object.audioDevice) : undefined,
  ...
  toJSON(message: VideoInput): unknown {
    ...
    message.userDescription !== undefined && (obj.userDescription = message.userDescription);
    ...
    message.displayColor !== undefined &&
      (obj.displayColor = message.displayColor ? Color.toJSON(message.displayColor) : undefined);
    message.thumbnailPath !== undefined &&
      (obj.thumbnailPath = message.thumbnailPath ? URL.toJSON(message.thumbnailPath) : undefined);
    message.audioType !== undefined && (obj.audioType = videoInput_AudioDeviceTypeToJSON(message.audioType));
    message.audioDevice !== undefined &&
      (obj.audioDevice = message.audioDevice ? DigitalAudio_Device.toJSON(message.audioDevice) : undefined);
    message.videoDevice !== undefined &&
      (obj.videoDevice = message.videoDevice ? Media_VideoDevice.toJSON(message.videoDevice) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<VideoInput>, I>>(object: I): VideoInput {
    const message = createBaseVideoInput();
    ...
    message.videoInputDevice = (object.videoInputDevice !== undefined && object.videoInputDevice !== null)
      ? Media_VideoDevice.fromPartial(object.videoInputDevice)
      : undefined;
    message.displayColor = (object.displayColor !== undefined && object.displayColor !== null)
      ? Color.fromPartial(object.displayColor)
      : undefined;
    message.thumbnailPath = (object.thumbnailPath !== undefined && object.thumbnailPath !== null)
...
export const VideoInput_SettingsDocument = {
  encode(message: VideoInput_SettingsDocument, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): VideoInput_SettingsDocument {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<VideoInput_SettingsDocument>, I>>(object: I): VideoInput_SettingsDocument {
    const message = createBaseVideoInput_SettingsDocument();
...
export const AudioInput = {
  encode(message: AudioInput, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.uuid !== undefined) {
      UUID.encode(message.uuid, writer.uint32(10).fork()).ldelim();
    }
    if (message.userDescription !== "") {
    ...
    if (message.behaviorMode !== undefined) {
      AudioInput_BehaviorMode.encode(message.behaviorMode, writer.uint32(42).fork()).ldelim();
    }
    if (message.audioDevice !== undefined) {
      DigitalAudio_Device.encode(message.audioDevice, writer.uint32(26).fork()).ldelim();
    }
    if (message.videoDevice !== undefined) {
      Media_VideoDevice.encode(message.videoDevice, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<AudioInput>, I>>(object: I): AudioInput {
    const message = createBaseAudioInput();
    message.uuid = (object.uuid !== undefined && object.uuid !== null) ? UUID.fromPartial(object.uuid) : undefined;
    message.userDescription = object.userDescription ?? "";
...
function createBaseAudioInput_BehaviorMode(): AudioInput_BehaviorMode {
  return { on: undefined, off: undefined, autoOn: undefined, autoOff: undefined };
}

export const AudioInput_BehaviorMode = {
  encode(message: AudioInput_BehaviorMode, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.on !== undefined) {
      AudioInput_BehaviorMode_On.encode(message.on, writer.uint32(10).fork()).ldelim();
    }
    if (message.off !== undefined) {
      AudioInput_BehaviorMode_Off.encode(message.off, writer.uint32(18).fork()).ldelim();
    }
    if (message.autoOn !== undefined) {
      AudioInput_BehaviorMode_AutoOn.encode(message.autoOn, writer.uint32(26).fork()).ldelim();
    }
    if (message.autoOff !== undefined) {
      AudioInput_BehaviorMode_AutoOff.encode(message.autoOff, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): AudioInput_BehaviorMode {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.on = AudioInput_BehaviorMode_On.decode(reader, reader.uint32());
          break;
        case 2:
          message.off = AudioInput_BehaviorMode_Off.decode(reader, reader.uint32());
          break;
        case 3:
          message.autoOn = AudioInput_BehaviorMode_AutoOn.decode(reader, reader.uint32());
          break;
        case 4:
          message.autoOff = AudioInput_BehaviorMode_AutoOff.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): AudioInput_BehaviorMode {
    return {
      on: isSet(object.on) ? AudioInput_BehaviorMode_On.fromJSON(object.on) : undefined,
      off: isSet(object.off) ? AudioInput_BehaviorMode_Off.fromJSON(object.off) : undefined,
      autoOn: isSet(object.autoOn) ? AudioInput_BehaviorMode_AutoOn.fromJSON(object.autoOn) : undefined,
      autoOff: isSet(object.autoOff) ? AudioInput_BehaviorMode_AutoOff.fromJSON(object.autoOff) : undefined,
    };
  },

  toJSON(message: AudioInput_BehaviorMode): unknown {
    const obj: any = {};
    message.on !== undefined && (obj.on = message.on ? AudioInput_BehaviorMode_On.toJSON(message.on) : undefined);
    message.off !== undefined && (obj.off = message.off ? AudioInput_BehaviorMode_Off.toJSON(message.off) : undefined);
    message.autoOn !== undefined &&
      (obj.autoOn = message.autoOn ? AudioInput_BehaviorMode_AutoOn.toJSON(message.autoOn) : undefined);
    message.autoOff !== undefined &&
      (obj.autoOff = message.autoOff ? AudioInput_BehaviorMode_AutoOff.toJSON(message.autoOff) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<AudioInput_BehaviorMode>, I>>(object: I): AudioInput_BehaviorMode {
    const message = createBaseAudioInput_BehaviorMode();
    ...
    message.off = (object.off !== undefined && object.off !== null)
      ...
      : undefined;
    message.autoOn = (object.autoOn !== undefined && object.autoOn !== null)
      ? AudioInput_BehaviorMode_AutoOn.fromPartial(object.autoOn)
      : undefined;
    message.autoOff = (object.autoOff !== undefined && object.autoOff !== null)
...
export const AudioInput_BehaviorMode_On = {
  encode(_: AudioInput_BehaviorMode_On, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): AudioInput_BehaviorMode_On {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<AudioInput_BehaviorMode_On>, I>>(_: I): AudioInput_BehaviorMode_On {
    const message = createBaseAudioInput_BehaviorMode_On();
    return message;
  },
};
...
export const AudioInput_BehaviorMode_Off = {
  encode(_: AudioInput_BehaviorMode_Off, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): AudioInput_BehaviorMode_Off {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<AudioInput_BehaviorMode_Off>, I>>(_: I): AudioInput_BehaviorMode_Off {
    const message = createBaseAudioInput_BehaviorMode_Off();
    return message;
  },
};
...
export const AudioInput_BehaviorMode_AutoOff = {
  encode(_: AudioInput_BehaviorMode_AutoOff, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): AudioInput_BehaviorMode_AutoOff {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<AudioInput_BehaviorMode_AutoOff>, I>>(_: I): AudioInput_BehaviorMode_AutoOff {
    const message = createBaseAudioInput_BehaviorMode_AutoOff();
    return message;
  },
};
...
export const AudioInput_BehaviorMode_AutoOn = {
  encode(message: AudioInput_BehaviorMode_AutoOn, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): AudioInput_BehaviorMode_AutoOn {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: AudioInput_BehaviorMode_AutoOn): unknown {
    ...
    if (message.linkedVideoInputs) {
      obj.linkedVideoInputs = message.linkedVideoInputs.map((e) => Math.round(e));
    } else {
