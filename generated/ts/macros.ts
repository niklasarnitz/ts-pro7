...
export const MacrosDocument = {
  encode(message: MacrosDocument, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.macros.push(MacrosDocument_Macro.decode(reader, reader.uint32()));
          break;
        default:
  ...
  fromJSON(object: any): MacrosDocument {
    return {
      ...
      macros: Array.isArray(object?.macros) ? object.macros.map((e: any) => MacrosDocument_Macro.fromJSON(e)) : [],
    };
  },
  ...
  toJSON(message: MacrosDocument): unknown {
    ...
    if (message.macros) {
      obj.macros = message.macros.map((e) => e ? MacrosDocument_Macro.toJSON(e) : undefined);
    } else {
      obj.macros = [];
    }
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<MacrosDocument>, I>>(object: I): MacrosDocument {
    const message = createBaseMacrosDocument();
    message.applicationInfo = (object.applicationInfo !== undefined && object.applicationInfo !== null)
      ...
      : undefined;
    message.macros = object.macros?.map((e) => MacrosDocument_Macro.fromPartial(e)) || [];
    return message;
  },
};

function createBaseMacrosDocument_Macro(): MacrosDocument_Macro {
  return { uuid: undefined, name: "", color: undefined, actions: [], triggerOnStartup: false };
}

export const MacrosDocument_Macro = {
  encode(message: MacrosDocument_Macro, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MacrosDocument_Macro {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): MacrosDocument_Macro {
    return {
      ...
      triggerOnStartup: isSet(object.triggerOnStartup) ? Boolean(object.triggerOnStartup) : false,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<MacrosDocument_Macro>, I>>(object: I): MacrosDocument_Macro {
    const message = createBaseMacrosDocument_Macro();
