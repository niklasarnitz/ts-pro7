...
import { Template_Identification } from "./template";
...
export interface Message {
  ...
  template: Template_Identification | undefined;
...
export const Message = {
  encode(message: Message, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.template !== undefined) {
      Template_Identification.encode(message.template, writer.uint32(50).fork()).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 6:
          message.template = Template_Identification.decode(reader, reader.uint32());
          break;
        case 9:
  ...
  fromJSON(object: any): Message {
    return {
      ...
      template: isSet(object.template) ? Template_Identification.fromJSON(object.template) : undefined,
  ...
  toJSON(message: Message): unknown {
    ...
    message.template !== undefined &&
      (obj.template = message.template ? Template_Identification.toJSON(message.template) : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<Message>, I>>(object: I): Message {
    ...
    message.template = (object.template !== undefined && object.template !== null)
      ? Template_Identification.fromPartial(object.template)
      : undefined;
