...
export function calendar_Event_DayOfWeekFromJSON(object: any): Calendar_Event_DayOfWeek {
  switch (object) {
    case 0:
...
export function calendar_Event_DayOfWeekToJSON(object: Calendar_Event_DayOfWeek): string {
  switch (object) {
...
export const Calendar = {
  encode(message: Calendar, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): Calendar {
    return {
      events: Array.isArray(object?.events) ? object.events.map((e: any) => Calendar_Event.fromJSON(e)) : [],
  ...
  toJSON(message: Calendar): unknown {
    const obj: any = {};
    if (message.events) {
      obj.events = message.events.map((e) => e ? Calendar_Event.toJSON(e) : undefined);
    } else {
      obj.events = [];
    }
  ...
  fromPartial<I extends Exact<DeepPartial<Calendar>, I>>(object: I): Calendar {
    const message = createBaseCalendar();
    message.events = object.events?.map((e) => Calendar_Event.fromPartial(e)) || [];
...
export const Calendar_Event = {
  encode(message: Calendar_Event, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.recurrenceLimitDate !== undefined) {
      Timestamp.encode(message.recurrenceLimitDate, writer.uint32(50).fork()).ldelim();
    }
    for (const v of message.recurrenceExcludedDates) {
      Timestamp.encode(v!, writer.uint32(58).fork()).ldelim();
    }
    if (message.action !== undefined) {
      Calendar_Event_Action.encode(message.action, writer.uint32(66).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 6:
          message.recurrenceLimitDate = Timestamp.decode(reader, reader.uint32());
          break;
        case 7:
          message.recurrenceExcludedDates.push(Timestamp.decode(reader, reader.uint32()));
          break;
        case 8:
          message.action = Calendar_Event_Action.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): Calendar_Event {
    return {
      ...
      recurrenceDays: Array.isArray(object?.recurrenceDays)
        ? object.recurrenceDays.map((e: any) => calendar_Event_DayOfWeekFromJSON(e))
        : [],
      ...
      recurrenceExcludedDates: Array.isArray(object?.recurrenceExcludedDates)
        ...
        : [],
      action: isSet(object.action) ? Calendar_Event_Action.fromJSON(object.action) : undefined,
    };
  },
  ...
  toJSON(message: Calendar_Event): unknown {
    ...
    if (message.recurrenceDays) {
      obj.recurrenceDays = message.recurrenceDays.map((e) => calendar_Event_DayOfWeekToJSON(e));
    } else {
      obj.recurrenceDays = [];
    }
    ...
    if (message.recurrenceExcludedDates) {
      obj.recurrenceExcludedDates = message.recurrenceExcludedDates.map((e) => e ? Timestamp.toJSON(e) : undefined);
    } else {
      obj.recurrenceExcludedDates = [];
    }
    message.action !== undefined &&
      (obj.action = message.action ? Calendar_Event_Action.toJSON(message.action) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<Calendar_Event>, I>>(object: I): Calendar_Event {
    const message = createBaseCalendar_Event();
    ...
    message.recurrenceLimitDate = (object.recurrenceLimitDate !== undefined && object.recurrenceLimitDate !== null)
      ? Timestamp.fromPartial(object.recurrenceLimitDate)
      : undefined;
    message.recurrenceExcludedDates = object.recurrenceExcludedDates?.map((e) => Timestamp.fromPartial(e)) || [];
...
export const Calendar_Event_Action = {
  encode(message: Calendar_Event_Action, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.type !== 0) {
    ...
    if (message.playlist !== undefined) {
      Calendar_Event_Action_Playlist.encode(message.playlist, writer.uint32(26).fork()).ldelim();
    }
    if (message.macro !== undefined) {
      Calendar_Event_Action_Macro.encode(message.macro, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): Calendar_Event_Action {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.playlist = Calendar_Event_Action_Playlist.decode(reader, reader.uint32());
          break;
        case 4:
          message.macro = Calendar_Event_Action_Macro.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): Calendar_Event_Action {
    return {
      ...
      uuid: isSet(object.uuid) ? UUID.fromJSON(object.uuid) : undefined,
      playlist: isSet(object.playlist) ? Calendar_Event_Action_Playlist.fromJSON(object.playlist) : undefined,
      macro: isSet(object.macro) ? Calendar_Event_Action_Macro.fromJSON(object.macro) : undefined,
    };
  },
  ...
  toJSON(message: Calendar_Event_Action): unknown {
    ...
    message.playlist !== undefined &&
      (obj.playlist = message.playlist ? Calendar_Event_Action_Playlist.toJSON(message.playlist) : undefined);
    message.macro !== undefined &&
      (obj.macro = message.macro ? Calendar_Event_Action_Macro.toJSON(message.macro) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<Calendar_Event_Action>, I>>(object: I): Calendar_Event_Action {
    const message = createBaseCalendar_Event_Action();
...
export const Calendar_Event_Action_Playlist = {
  encode(message: Calendar_Event_Action_Playlist, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Calendar_Event_Action_Playlist {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Calendar_Event_Action_Playlist {
    return {
      ...
      playlistItemUuid: isSet(object.playlistItemUuid) ? UUID.fromJSON(object.playlistItemUuid) : undefined,
    };
  },
  ...
  toJSON(message: Calendar_Event_Action_Playlist): unknown {
    ...
    message.playlistItemUuid !== undefined &&
      (obj.playlistItemUuid = message.playlistItemUuid ? UUID.toJSON(message.playlistItemUuid) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Calendar_Event_Action_Playlist>, I>>(
    ...
    message.playlistUuid = (object.playlistUuid !== undefined && object.playlistUuid !== null)
      ...
      : undefined;
    message.playlistItemUuid = (object.playlistItemUuid !== undefined && object.playlistItemUuid !== null)
...
export const Calendar_Event_Action_Macro = {
  encode(message: Calendar_Event_Action_Macro, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Calendar_Event_Action_Macro {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<Calendar_Event_Action_Macro>, I>>(object: I): Calendar_Event_Action_Macro {
    const message = createBaseCalendar_Event_Action_Macro();
