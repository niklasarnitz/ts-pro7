...
export const PropDocument = {
  encode(message: PropDocument, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromPartial<I extends Exact<DeepPartial<PropDocument>, I>>(object: I): PropDocument {
    const message = createBasePropDocument();
