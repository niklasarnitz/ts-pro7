...
export const PlanningCenterPlan = {
  encode(message: PlanningCenterPlan, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.lastUpdateCheckDate !== undefined) {
      Timestamp.encode(message.lastUpdateCheckDate, writer.uint32(66).fork()).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          ...
          break;
        case 8:
          message.lastUpdateCheckDate = Timestamp.decode(reader, reader.uint32());
          break;
        case 9:
  ...
  fromJSON(object: any): PlanningCenterPlan {
    return {
      ...
      createdDate: isSet(object.createdDate) ? Timestamp.fromJSON(object.createdDate) : undefined,
      updateDate: isSet(object.updateDate) ? Timestamp.fromJSON(object.updateDate) : undefined,
  ...
  toJSON(message: PlanningCenterPlan): unknown {
    const obj: any = {};
    message.planIdNum !== undefined && (obj.planIdNum = Math.round(message.planIdNum));
    message.parentIdNum !== undefined && (obj.parentIdNum = Math.round(message.parentIdNum));
    message.seriesTitle !== undefined && (obj.seriesTitle = message.seriesTitle);
    ...
    message.createdDate !== undefined &&
      (obj.createdDate = message.createdDate ? Timestamp.toJSON(message.createdDate) : undefined);
    ...
    message.parentIdStr !== undefined && (obj.parentIdStr = message.parentIdStr);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<PlanningCenterPlan>, I>>(object: I): PlanningCenterPlan {
    const message = createBasePlanningCenterPlan();
    ...
    message.createdDate = (object.createdDate !== undefined && object.createdDate !== null)
      ? Timestamp.fromPartial(object.createdDate)
      : undefined;
    message.updateDate = (object.updateDate !== undefined && object.updateDate !== null)
      ? Timestamp.fromPartial(object.updateDate)
      : undefined;
    message.lastUpdateCheckDate = (object.lastUpdateCheckDate !== undefined && object.lastUpdateCheckDate !== null)
...
export const PlanningCenterPlan_PlanItem = {
  encode(message: PlanningCenterPlan_PlanItem, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.attachments) {
      PlanningCenterPlan_PlanItem_Attachment.encode(v!, writer.uint32(50).fork()).ldelim();
    }
    if (message.updateDate !== undefined) {
      Timestamp.encode(message.updateDate, writer.uint32(58).fork()).ldelim();
    }
    if (message.linkedSong !== undefined) {
      PlanningCenterPlan_PlanItem_SongItem.encode(message.linkedSong, writer.uint32(66).fork()).ldelim();
    }
    if (message.pcoIdStr !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PlanningCenterPlan_PlanItem {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 6:
          message.attachments.push(PlanningCenterPlan_PlanItem_Attachment.decode(reader, reader.uint32()));
          break;
        case 7:
          message.updateDate = Timestamp.decode(reader, reader.uint32());
          break;
        case 8:
          message.linkedSong = PlanningCenterPlan_PlanItem_SongItem.decode(reader, reader.uint32());
          break;
        case 9:
  ...
  fromJSON(object: any): PlanningCenterPlan_PlanItem {
    return {
      itemType: isSet(object.itemType) ? planningCenterPlan_PlanItem_PlanItemTypeFromJSON(object.itemType) : 0,
      pcoIdNum: isSet(object.pcoIdNum) ? Number(object.pcoIdNum) : 0,
      serviceIdNum: isSet(object.serviceIdNum) ? Number(object.serviceIdNum) : 0,
      parentIdNum: isSet(object.parentIdNum) ? Number(object.parentIdNum) : 0,
      name: isSet(object.name) ? String(object.name) : "",
      attachments: Array.isArray(object?.attachments)
        ? object.attachments.map((e: any) => PlanningCenterPlan_PlanItem_Attachment.fromJSON(e))
        : [],
      updateDate: isSet(object.updateDate) ? Timestamp.fromJSON(object.updateDate) : undefined,
      ...
      serviceIdStr: isSet(object.serviceIdStr) ? String(object.serviceIdStr) : "",
      parentIdStr: isSet(object.parentIdStr) ? String(object.parentIdStr) : "",
    };
  },
  ...
  toJSON(message: PlanningCenterPlan_PlanItem): unknown {
    const obj: any = {};
    message.itemType !== undefined && (obj.itemType = planningCenterPlan_PlanItem_PlanItemTypeToJSON(message.itemType));
    message.pcoIdNum !== undefined && (obj.pcoIdNum = Math.round(message.pcoIdNum));
    message.serviceIdNum !== undefined && (obj.serviceIdNum = Math.round(message.serviceIdNum));
    message.parentIdNum !== undefined && (obj.parentIdNum = Math.round(message.parentIdNum));
    ...
    message.serviceIdStr !== undefined && (obj.serviceIdStr = message.serviceIdStr);
    message.parentIdStr !== undefined && (obj.parentIdStr = message.parentIdStr);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<PlanningCenterPlan_PlanItem>, I>>(object: I): PlanningCenterPlan_PlanItem {
    const message = createBasePlanningCenterPlan_PlanItem();
    ...
    message.attachments = object.attachments?.map((e) => PlanningCenterPlan_PlanItem_Attachment.fromPartial(e)) || [];
    message.updateDate = (object.updateDate !== undefined && object.updateDate !== null)
      ? Timestamp.fromPartial(object.updateDate)
      : undefined;
    message.linkedSong = (object.linkedSong !== undefined && object.linkedSong !== null)
...
export const PlanningCenterPlan_PlanItem_Attachment = {
  encode(message: PlanningCenterPlan_PlanItem_Attachment, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PlanningCenterPlan_PlanItem_Attachment {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): PlanningCenterPlan_PlanItem_Attachment {
    return {
      ...
      createdDate: isSet(object.createdDate) ? Timestamp.fromJSON(object.createdDate) : undefined,
      linkedPath: isSet(object.linkedPath) ? URL.fromJSON(object.linkedPath) : undefined,
      pcoIdNum: isSet(object.pcoIdNum) ? Number(object.pcoIdNum) : 0,
      needsUpdate: isSet(object.needsUpdate) ? Boolean(object.needsUpdate) : false,
      updateDate: isSet(object.updateDate) ? Timestamp.fromJSON(object.updateDate) : undefined,
      pcoIdStr: isSet(object.pcoIdStr) ? String(object.pcoIdStr) : "",
    };
  },
  ...
  toJSON(message: PlanningCenterPlan_PlanItem_Attachment): unknown {
    ...
    message.linkedPath !== undefined &&
      (obj.linkedPath = message.linkedPath ? URL.toJSON(message.linkedPath) : undefined);
    message.pcoIdNum !== undefined && (obj.pcoIdNum = Math.round(message.pcoIdNum));
    message.needsUpdate !== undefined && (obj.needsUpdate = message.needsUpdate);
    message.updateDate !== undefined &&
      (obj.updateDate = message.updateDate ? Timestamp.toJSON(message.updateDate) : undefined);
    message.pcoIdStr !== undefined && (obj.pcoIdStr = message.pcoIdStr);
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<PlanningCenterPlan_PlanItem_Attachment>, I>>(
    object: I,
    ...
    message.createdDate = (object.createdDate !== undefined && object.createdDate !== null)
      ? Timestamp.fromPartial(object.createdDate)
      : undefined;
    message.linkedPath = (object.linkedPath !== undefined && object.linkedPath !== null)
...
function createBasePlanningCenterPlan_PlanItem_SongItem(): PlanningCenterPlan_PlanItem_SongItem {
  return { pcoIdNum: 0, arrangementIdNum: 0, ccli: undefined, sequence: undefined, pcoIdStr: "", arrangementIdStr: "" };
}

export const PlanningCenterPlan_PlanItem_SongItem = {
  encode(message: PlanningCenterPlan_PlanItem_SongItem, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.pcoIdNum !== 0) {
    ...
    if (message.sequence !== undefined) {
      PlanningCenterPlan_PlanItem_SongItem_Sequence.encode(message.sequence, writer.uint32(34).fork()).ldelim();
    }
    if (message.pcoIdStr !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PlanningCenterPlan_PlanItem_SongItem {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.sequence = PlanningCenterPlan_PlanItem_SongItem_Sequence.decode(reader, reader.uint32());
          break;
        case 5:
          message.pcoIdStr = reader.string();
          break;
  ...
  fromJSON(object: any): PlanningCenterPlan_PlanItem_SongItem {
    return {
      pcoIdNum: isSet(object.pcoIdNum) ? Number(object.pcoIdNum) : 0,
      arrangementIdNum: isSet(object.arrangementIdNum) ? Number(object.arrangementIdNum) : 0,
      ccli: isSet(object.ccli) ? Presentation_CCLI.fromJSON(object.ccli) : undefined,
      sequence: isSet(object.sequence)
        ? PlanningCenterPlan_PlanItem_SongItem_Sequence.fromJSON(object.sequence)
        : undefined,
      pcoIdStr: isSet(object.pcoIdStr) ? String(object.pcoIdStr) : "",
      arrangementIdStr: isSet(object.arrangementIdStr) ? String(object.arrangementIdStr) : "",
    };
  },
  ...
  toJSON(message: PlanningCenterPlan_PlanItem_SongItem): unknown {
    const obj: any = {};
    message.pcoIdNum !== undefined && (obj.pcoIdNum = Math.round(message.pcoIdNum));
    message.arrangementIdNum !== undefined && (obj.arrangementIdNum = Math.round(message.arrangementIdNum));
    ...
    message.sequence !== undefined && (obj.sequence = message.sequence
      ...
      : undefined);
    message.pcoIdStr !== undefined && (obj.pcoIdStr = message.pcoIdStr);
    message.arrangementIdStr !== undefined && (obj.arrangementIdStr = message.arrangementIdStr);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<PlanningCenterPlan_PlanItem_SongItem>, I>>(
    object: I,
    ...
    message.sequence = (object.sequence !== undefined && object.sequence !== null)
      ? PlanningCenterPlan_PlanItem_SongItem_Sequence.fromPartial(object.sequence)
      : undefined;
    message.pcoIdStr = object.pcoIdStr ?? "";
...
export const PlanningCenterPlan_PlanItem_SongItem_Sequence = {
  encode(message: PlanningCenterPlan_PlanItem_SongItem_Sequence, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.pcoIdNum !== 0) {
      writer.uint32(8).uint32(message.pcoIdNum);
    }
    if (message.name !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PlanningCenterPlan_PlanItem_SongItem_Sequence {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<PlanningCenterPlan_PlanItem_SongItem_Sequence>, I>>(
    object: I,
