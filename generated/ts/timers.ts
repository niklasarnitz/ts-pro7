...
export function clock_Format_DateFormatterStyleFromJSON(object: any): Clock_Format_DateFormatterStyle {
  switch (object) {
    case 0:
...
export function clock_Format_DateFormatterStyleToJSON(object: Clock_Format_DateFormatterStyle): string {
  switch (object) {
...
export const Clock_Format = {
  encode(message: Clock_Format, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): Clock_Format {
    return {
      dateType: isSet(object.dateType) ? clock_Format_DateFormatterStyleFromJSON(object.dateType) : 0,
      timeFormat: isSet(object.timeFormat) ? clock_Format_DateFormatterStyleFromJSON(object.timeFormat) : 0,
      militaryTimeEnabled: isSet(object.militaryTimeEnabled) ? Boolean(object.militaryTimeEnabled) : false,
    };
  },

  toJSON(message: Clock_Format): unknown {
    const obj: any = {};
    message.dateType !== undefined && (obj.dateType = clock_Format_DateFormatterStyleToJSON(message.dateType));
    message.timeFormat !== undefined && (obj.timeFormat = clock_Format_DateFormatterStyleToJSON(message.timeFormat));
    message.militaryTimeEnabled !== undefined && (obj.militaryTimeEnabled = message.militaryTimeEnabled);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<Clock_Format>, I>>(object: I): Clock_Format {
    const message = createBaseClock_Format();
...
export const Timer = {
  encode(message: Timer, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.configuration !== undefined) {
      Timer_Configuration.encode(message.configuration, writer.uint32(82).fork()).ldelim();
    }
    return writer;
  },
...
export const Timer_Format = {
  encode(message: Timer_Format, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.hour !== 0) {
  ...
  fromJSON(object: any): Timer_Format {
    return {
      ...
      minute: isSet(object.minute) ? timer_Format_StyleFromJSON(object.minute) : 0,
      second: isSet(object.second) ? timer_Format_StyleFromJSON(object.second) : 0,
      millisecond: isSet(object.millisecond) ? timer_Format_StyleFromJSON(object.millisecond) : 0,
      isWallClockTime: isSet(object.isWallClockTime) ? Boolean(object.isWallClockTime) : false,
      is24HourTime: isSet(object.is24HourTime) ? Boolean(object.is24HourTime) : false,
      showMillisecondsUnderMinuteOnly: isSet(object.showMillisecondsUnderMinuteOnly)
  ...
  toJSON(message: Timer_Format): unknown {
    const obj: any = {};
    message.hour !== undefined && (obj.hour = timer_Format_StyleToJSON(message.hour));
    message.minute !== undefined && (obj.minute = timer_Format_StyleToJSON(message.minute));
    message.second !== undefined && (obj.second = timer_Format_StyleToJSON(message.second));
    message.millisecond !== undefined && (obj.millisecond = timer_Format_StyleToJSON(message.millisecond));
    message.isWallClockTime !== undefined && (obj.isWallClockTime = message.isWallClockTime);
    message.is24HourTime !== undefined && (obj.is24HourTime = message.is24HourTime);
    message.showMillisecondsUnderMinuteOnly !== undefined &&
      (obj.showMillisecondsUnderMinuteOnly = message.showMillisecondsUnderMinuteOnly);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<Timer_Format>, I>>(object: I): Timer_Format {
    const message = createBaseTimer_Format();
    ...
    message.showMillisecondsUnderMinuteOnly = object.showMillisecondsUnderMinuteOnly ?? false;
    return message;
  },
};

function createBaseTimer_Configuration(): Timer_Configuration {
  return { allowsOverrun: false, countdown: undefined, countdownToTime: undefined, elapsedTime: undefined };
}

export const Timer_Configuration = {
  encode(message: Timer_Configuration, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.allowsOverrun === true) {
      writer.uint32(32).bool(message.allowsOverrun);
    }
    if (message.countdown !== undefined) {
      Timer_Configuration_TimerTypeCountdown.encode(message.countdown, writer.uint32(10).fork()).ldelim();
    }
    if (message.countdownToTime !== undefined) {
      Timer_Configuration_TimerTypeCountdownToTime.encode(message.countdownToTime, writer.uint32(18).fork()).ldelim();
    }
    if (message.elapsedTime !== undefined) {
      Timer_Configuration_TimerTypeElapsedTime.encode(message.elapsedTime, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 4:
          ...
          break;
        case 1:
          message.countdown = Timer_Configuration_TimerTypeCountdown.decode(reader, reader.uint32());
          break;
        case 2:
          message.countdownToTime = Timer_Configuration_TimerTypeCountdownToTime.decode(reader, reader.uint32());
          break;
        case 3:
          message.elapsedTime = Timer_Configuration_TimerTypeElapsedTime.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): Timer_Configuration {
    return {
      ...
      countdownToTime: isSet(object.countdownToTime)
        ? Timer_Configuration_TimerTypeCountdownToTime.fromJSON(object.countdownToTime)
        : undefined,
  ...
  toJSON(message: Timer_Configuration): unknown {
    ...
    message.countdownToTime !== undefined && (obj.countdownToTime = message.countdownToTime
      ? Timer_Configuration_TimerTypeCountdownToTime.toJSON(message.countdownToTime)
      : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<Timer_Configuration>, I>>(object: I): Timer_Configuration {
    const message = createBaseTimer_Configuration();
    ...
    message.countdownToTime = (object.countdownToTime !== undefined && object.countdownToTime !== null)
      ? Timer_Configuration_TimerTypeCountdownToTime.fromPartial(object.countdownToTime)
      : undefined;
    message.elapsedTime = (object.elapsedTime !== undefined && object.elapsedTime !== null)
      ? Timer_Configuration_TimerTypeElapsedTime.fromPartial(object.elapsedTime)
      : undefined;
    return message;
  },
};
...
export const Timer_Configuration_TimerTypeCountdown = {
  encode(message: Timer_Configuration_TimerTypeCountdown, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Timer_Configuration_TimerTypeCountdown {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<Timer_Configuration_TimerTypeCountdown>, I>>(
    object: I,
...
export const Timer_Configuration_TimerTypeCountdownToTime = {
  encode(message: Timer_Configuration_TimerTypeCountdownToTime, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Timer_Configuration_TimerTypeCountdownToTime {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Timer_Configuration_TimerTypeCountdownToTime {
    return {
      ...
      period: isSet(object.period) ? timer_Configuration_TimerTypeCountdownToTime_TimePeriodFromJSON(object.period) : 0,
    };
  },
  ...
  toJSON(message: Timer_Configuration_TimerTypeCountdownToTime): unknown {
    ...
    message.period !== undefined &&
      (obj.period = timer_Configuration_TimerTypeCountdownToTime_TimePeriodToJSON(message.period));
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<Timer_Configuration_TimerTypeCountdownToTime>, I>>(
    object: I,
...
export const Timer_Configuration_TimerTypeElapsedTime = {
  encode(message: Timer_Configuration_TimerTypeElapsedTime, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Timer_Configuration_TimerTypeElapsedTime {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<Timer_Configuration_TimerTypeElapsedTime>, I>>(
    object: I,
...
export const TimersDocument = {
  encode(message: TimersDocument, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): TimersDocument {
    return {
      ...
      timers: Array.isArray(object?.timers) ? object.timers.map((e: any) => Timer.fromJSON(e)) : [],
    };
  },
  ...
  toJSON(message: TimersDocument): unknown {
    ...
    message.clock !== undefined && (obj.clock = message.clock ? Clock.toJSON(message.clock) : undefined);
    if (message.timers) {
  ...
  fromPartial<I extends Exact<DeepPartial<TimersDocument>, I>>(object: I): TimersDocument {
    const message = createBaseTimersDocument();
