...
import { PlanningCenterPlan, PlanningCenterPlan_PlanItem } from "./planningCenter";
...
export function playlist_FolderDirectory_ImportBehaviorFromJSON(object: any): Playlist_FolderDirectory_ImportBehavior {
  switch (object) {
    case 0:
...
export function playlist_FolderDirectory_ImportBehaviorToJSON(object: Playlist_FolderDirectory_ImportBehavior): string {
  switch (object) {
...
export interface PlaylistItem_Presentation {
  ...
  contentDestination: PlaylistItem_Presentation_ContentDestination;
  userMusicKey: MusicKeyScale | undefined;
}

export enum PlaylistItem_Presentation_ContentDestination {
  CONTENT_DESTINATION_GLOBAL = 0,
  CONTENT_DESTINATION_ANNOUNCEMENTS = 1,
  UNRECOGNIZED = -1,
}

export function playlistItem_Presentation_ContentDestinationFromJSON(
  object: any,
): PlaylistItem_Presentation_ContentDestination {
  switch (object) {
    case 0:
    case "CONTENT_DESTINATION_GLOBAL":
      return PlaylistItem_Presentation_ContentDestination.CONTENT_DESTINATION_GLOBAL;
    case 1:
    case "CONTENT_DESTINATION_ANNOUNCEMENTS":
      return PlaylistItem_Presentation_ContentDestination.CONTENT_DESTINATION_ANNOUNCEMENTS;
    case -1:
    case "UNRECOGNIZED":
    default:
      return PlaylistItem_Presentation_ContentDestination.UNRECOGNIZED;
  }
}

export function playlistItem_Presentation_ContentDestinationToJSON(
  object: PlaylistItem_Presentation_ContentDestination,
): string {
  switch (object) {
    case PlaylistItem_Presentation_ContentDestination.CONTENT_DESTINATION_GLOBAL:
      return "CONTENT_DESTINATION_GLOBAL";
    case PlaylistItem_Presentation_ContentDestination.CONTENT_DESTINATION_ANNOUNCEMENTS:
      return "CONTENT_DESTINATION_ANNOUNCEMENTS";
    case PlaylistItem_Presentation_ContentDestination.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export const Playlist = {
  encode(message: Playlist, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.startupInfo !== undefined) {
      Playlist_StartupInfo.encode(message.startupInfo, writer.uint32(130).fork()).ldelim();
    }
    if (message.playlists !== undefined) {
      Playlist_PlaylistArray.encode(message.playlists, writer.uint32(98).fork()).ldelim();
    }
    if (message.items !== undefined) {
      Playlist_PlaylistItems.encode(message.items, writer.uint32(106).fork()).ldelim();
    }
    if (message.smartDirectory !== undefined) {
      Playlist_FolderDirectory.encode(message.smartDirectory, writer.uint32(114).fork()).ldelim();
    }
    if (message.pcoPlan !== undefined) {
      PlanningCenterPlan.encode(message.pcoPlan, writer.uint32(122).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11:
          ...
          break;
        case 16:
          message.startupInfo = Playlist_StartupInfo.decode(reader, reader.uint32());
          break;
        case 12:
          message.playlists = Playlist_PlaylistArray.decode(reader, reader.uint32());
          break;
        case 13:
          message.items = Playlist_PlaylistItems.decode(reader, reader.uint32());
          break;
        case 14:
          message.smartDirectory = Playlist_FolderDirectory.decode(reader, reader.uint32());
          break;
        case 15:
  ...
  fromJSON(object: any): Playlist {
    return {
      ...
      targetedLayerUuid: isSet(object.targetedLayerUuid) ? UUID.fromJSON(object.targetedLayerUuid) : undefined,
      smartDirectoryPath: isSet(object.smartDirectoryPath) ? URL.fromJSON(object.smartDirectoryPath) : undefined,
      ...
      children: Array.isArray(object?.children) ? object.children.map((e: any) => Playlist.fromJSON(e)) : [],
      timecodeEnabled: isSet(object.timecodeEnabled) ? Boolean(object.timecodeEnabled) : false,
      timing: isSet(object.timing) ? playlist_TimingTypeFromJSON(object.timing) : 0,
      startupInfo: isSet(object.startupInfo) ? Playlist_StartupInfo.fromJSON(object.startupInfo) : undefined,
      playlists: isSet(object.playlists) ? Playlist_PlaylistArray.fromJSON(object.playlists) : undefined,
      items: isSet(object.items) ? Playlist_PlaylistItems.fromJSON(object.items) : undefined,
      smartDirectory: isSet(object.smartDirectory)
        ? Playlist_FolderDirectory.fromJSON(object.smartDirectory)
        : undefined,
      pcoPlan: isSet(object.pcoPlan) ? PlanningCenterPlan.fromJSON(object.pcoPlan) : undefined,
    };
  },
  ...
  toJSON(message: Playlist): unknown {
    ...
    message.type !== undefined && (obj.type = playlist_TypeToJSON(message.type));
    message.expanded !== undefined && (obj.expanded = message.expanded);
    message.targetedLayerUuid !== undefined &&
      (obj.targetedLayerUuid = message.targetedLayerUuid ? UUID.toJSON(message.targetedLayerUuid) : undefined);
    message.smartDirectoryPath !== undefined &&
      (obj.smartDirectoryPath = message.smartDirectoryPath ? URL.toJSON(message.smartDirectoryPath) : undefined);
    ...
    if (message.children) {
      obj.children = message.children.map((e) => e ? Playlist.toJSON(e) : undefined);
    } else {
      obj.children = [];
    }
    message.timecodeEnabled !== undefined && (obj.timecodeEnabled = message.timecodeEnabled);
    message.timing !== undefined && (obj.timing = playlist_TimingTypeToJSON(message.timing));
    ...
    message.playlists !== undefined &&
      (obj.playlists = message.playlists ? Playlist_PlaylistArray.toJSON(message.playlists) : undefined);
    message.items !== undefined &&
      (obj.items = message.items ? Playlist_PlaylistItems.toJSON(message.items) : undefined);
    ...
    message.pcoPlan !== undefined &&
      (obj.pcoPlan = message.pcoPlan ? PlanningCenterPlan.toJSON(message.pcoPlan) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Playlist>, I>>(object: I): Playlist {
    ...
    message.targetedLayerUuid = (object.targetedLayerUuid !== undefined && object.targetedLayerUuid !== null)
      ? UUID.fromPartial(object.targetedLayerUuid)
      : undefined;
    message.smartDirectoryPath = (object.smartDirectoryPath !== undefined && object.smartDirectoryPath !== null)
    ...
    message.children = object.children?.map((e) => Playlist.fromPartial(e)) || [];
    message.timecodeEnabled = object.timecodeEnabled ?? false;
    message.timing = object.timing ?? 0;
    message.startupInfo = (object.startupInfo !== undefined && object.startupInfo !== null)
    ...
    message.items = (object.items !== undefined && object.items !== null)
      ...
      : undefined;
    message.smartDirectory = (object.smartDirectory !== undefined && object.smartDirectory !== null)
      ? Playlist_FolderDirectory.fromPartial(object.smartDirectory)
      : undefined;
    message.pcoPlan = (object.pcoPlan !== undefined && object.pcoPlan !== null)
...
export const Playlist_PlaylistArray = {
  encode(message: Playlist_PlaylistArray, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Playlist_PlaylistArray {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<Playlist_PlaylistArray>, I>>(object: I): Playlist_PlaylistArray {
    const message = createBasePlaylist_PlaylistArray();
...
export const Playlist_PlaylistItems = {
  encode(message: Playlist_PlaylistItems, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Playlist_PlaylistItems {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Playlist_PlaylistItems {
    return { items: Array.isArray(object?.items) ? object.items.map((e: any) => PlaylistItem.fromJSON(e)) : [] };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Playlist_PlaylistItems>, I>>(object: I): Playlist_PlaylistItems {
    const message = createBasePlaylist_PlaylistItems();
...
export const Playlist_FolderDirectory = {
  encode(message: Playlist_FolderDirectory, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.smartDirectory !== undefined) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Playlist_FolderDirectory {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Playlist_FolderDirectory {
    return {
      smartDirectory: isSet(object.smartDirectory) ? URL.fromJSON(object.smartDirectory) : undefined,
  ...
  toJSON(message: Playlist_FolderDirectory): unknown {
    const obj: any = {};
    message.smartDirectory !== undefined &&
      (obj.smartDirectory = message.smartDirectory ? URL.toJSON(message.smartDirectory) : undefined);
    message.importBehavior !== undefined &&
      (obj.importBehavior = playlist_FolderDirectory_ImportBehaviorToJSON(message.importBehavior));
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<Playlist_FolderDirectory>, I>>(object: I): Playlist_FolderDirectory {
    const message = createBasePlaylist_FolderDirectory();
    message.smartDirectory = (object.smartDirectory !== undefined && object.smartDirectory !== null)
...
export const Playlist_Tag = {
  encode(message: Playlist_Tag, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromPartial<I extends Exact<DeepPartial<Playlist_Tag>, I>>(object: I): Playlist_Tag {
    const message = createBasePlaylist_Tag();
...
export const Playlist_StartupInfo = {
  encode(message: Playlist_StartupInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Playlist_StartupInfo {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): Playlist_StartupInfo {
    return { triggerOnStartup: isSet(object.triggerOnStartup) ? Boolean(object.triggerOnStartup) : false };
  },

  toJSON(message: Playlist_StartupInfo): unknown {
    const obj: any = {};
    message.triggerOnStartup !== undefined && (obj.triggerOnStartup = message.triggerOnStartup);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<Playlist_StartupInfo>, I>>(object: I): Playlist_StartupInfo {
    const message = createBasePlaylist_StartupInfo();
...
export const PlaylistItem = {
  encode(message: PlaylistItem, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.header !== undefined) {
      PlaylistItem_Header.encode(message.header, writer.uint32(26).fork()).ldelim();
    }
    if (message.presentation !== undefined) {
      PlaylistItem_Presentation.encode(message.presentation, writer.uint32(34).fork()).ldelim();
    }
    if (message.cue !== undefined) {
      Cue.encode(message.cue, writer.uint32(42).fork()).ldelim();
    }
    if (message.planningCenter !== undefined) {
      PlaylistItem_PlanningCenter.encode(message.planningCenter, writer.uint32(50).fork()).ldelim();
    }
    if (message.placeholder !== undefined) {
      PlaylistItem_Placeholder.encode(message.placeholder, writer.uint32(66).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.presentation = PlaylistItem_Presentation.decode(reader, reader.uint32());
          break;
        case 5:
          message.cue = Cue.decode(reader, reader.uint32());
          break;
        case 6:
          message.planningCenter = PlaylistItem_PlanningCenter.decode(reader, reader.uint32());
          break;
        case 8:
          message.placeholder = PlaylistItem_Placeholder.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromJSON(object: any): PlaylistItem {
    return {
      uuid: isSet(object.uuid) ? UUID.fromJSON(object.uuid) : undefined,
      name: isSet(object.name) ? String(object.name) : "",
      tags: Array.isArray(object?.tags) ? object.tags.map((e: any) => UUID.fromJSON(e)) : [],
      isHidden: isSet(object.isHidden) ? Boolean(object.isHidden) : false,
      header: isSet(object.header) ? PlaylistItem_Header.fromJSON(object.header) : undefined,
      presentation: isSet(object.presentation) ? PlaylistItem_Presentation.fromJSON(object.presentation) : undefined,
      ...
      planningCenter: isSet(object.planningCenter)
        ...
        : undefined,
      placeholder: isSet(object.placeholder) ? PlaylistItem_Placeholder.fromJSON(object.placeholder) : undefined,
    };
  },
  ...
  toJSON(message: PlaylistItem): unknown {
    ...
    message.header !== undefined &&
      (obj.header = message.header ? PlaylistItem_Header.toJSON(message.header) : undefined);
    message.presentation !== undefined &&
      (obj.presentation = message.presentation ? PlaylistItem_Presentation.toJSON(message.presentation) : undefined);
...
export const PlaylistItem_Header = {
  encode(message: PlaylistItem_Header, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.color !== undefined) {
      Color.encode(message.color, writer.uint32(10).fork()).ldelim();
    }
  ...
  fromPartial<I extends Exact<DeepPartial<PlaylistItem_Header>, I>>(object: I): PlaylistItem_Header {
    const message = createBasePlaylistItem_Header();
    message.color = (object.color !== undefined && object.color !== null) ? Color.fromPartial(object.color) : undefined;
...
function createBasePlaylistItem_Presentation(): PlaylistItem_Presentation {
  return { documentPath: undefined, arrangement: undefined, contentDestination: 0, userMusicKey: undefined };
}

export const PlaylistItem_Presentation = {
  encode(message: PlaylistItem_Presentation, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.userMusicKey !== undefined) {
      MusicKeyScale.encode(message.userMusicKey, writer.uint32(34).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): PlaylistItem_Presentation {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): PlaylistItem_Presentation {
    return {
      documentPath: isSet(object.documentPath) ? URL.fromJSON(object.documentPath) : undefined,
      arrangement: isSet(object.arrangement) ? UUID.fromJSON(object.arrangement) : undefined,
      contentDestination: isSet(object.contentDestination)
        ? playlistItem_Presentation_ContentDestinationFromJSON(object.contentDestination)
        : 0,
      userMusicKey: isSet(object.userMusicKey) ? MusicKeyScale.fromJSON(object.userMusicKey) : undefined,
    };
  },
  ...
  toJSON(message: PlaylistItem_Presentation): unknown {
    ...
    message.documentPath !== undefined &&
      (obj.documentPath = message.documentPath ? URL.toJSON(message.documentPath) : undefined);
    message.arrangement !== undefined &&
      (obj.arrangement = message.arrangement ? UUID.toJSON(message.arrangement) : undefined);
    message.contentDestination !== undefined &&
      (obj.contentDestination = playlistItem_Presentation_ContentDestinationToJSON(message.contentDestination));
    message.userMusicKey !== undefined &&
      (obj.userMusicKey = message.userMusicKey ? MusicKeyScale.toJSON(message.userMusicKey) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<PlaylistItem_Presentation>, I>>(object: I): PlaylistItem_Presentation {
    const message = createBasePlaylistItem_Presentation();
    message.documentPath = (object.documentPath !== undefined && object.documentPath !== null)
      ? URL.fromPartial(object.documentPath)
      : undefined;
    message.arrangement = (object.arrangement !== undefined && object.arrangement !== null)
      ? UUID.fromPartial(object.arrangement)
      : undefined;
    message.contentDestination = object.contentDestination ?? 0;
    message.userMusicKey = (object.userMusicKey !== undefined && object.userMusicKey !== null)
...
export const PlaylistItem_PlanningCenter = {
  encode(message: PlaylistItem_PlanningCenter, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.item !== undefined) {
      PlanningCenterPlan_PlanItem.encode(message.item, writer.uint32(10).fork()).ldelim();
    }
    if (message.linkedData !== undefined) {
      PlaylistItem.encode(message.linkedData, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): PlaylistItem_PlanningCenter {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.item = PlanningCenterPlan_PlanItem.decode(reader, reader.uint32());
          break;
        case 2:
  ...
  fromJSON(object: any): PlaylistItem_PlanningCenter {
    return {
      item: isSet(object.item) ? PlanningCenterPlan_PlanItem.fromJSON(object.item) : undefined,
      linkedData: isSet(object.linkedData) ? PlaylistItem.fromJSON(object.linkedData) : undefined,
    };
  },
  ...
  toJSON(message: PlaylistItem_PlanningCenter): unknown {
    ...
    message.item !== undefined &&
      (obj.item = message.item ? PlanningCenterPlan_PlanItem.toJSON(message.item) : undefined);
    message.linkedData !== undefined &&
      (obj.linkedData = message.linkedData ? PlaylistItem.toJSON(message.linkedData) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<PlaylistItem_PlanningCenter>, I>>(object: I): PlaylistItem_PlanningCenter {
    const message = createBasePlaylistItem_PlanningCenter();
    message.item = (object.item !== undefined && object.item !== null)
      ? PlanningCenterPlan_PlanItem.fromPartial(object.item)
      : undefined;
    message.linkedData = (object.linkedData !== undefined && object.linkedData !== null)
...
export const PlaylistItem_Placeholder = {
  encode(message: PlaylistItem_Placeholder, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.linkedData !== undefined) {
      PlaylistItem.encode(message.linkedData, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): PlaylistItem_Placeholder {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): PlaylistItem_Placeholder {
    return { linkedData: isSet(object.linkedData) ? PlaylistItem.fromJSON(object.linkedData) : undefined };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<PlaylistItem_Placeholder>, I>>(object: I): PlaylistItem_Placeholder {
    const message = createBasePlaylistItem_Placeholder();
    message.linkedData = (object.linkedData !== undefined && object.linkedData !== null)
      ? PlaylistItem.fromPartial(object.linkedData)
      : undefined;
